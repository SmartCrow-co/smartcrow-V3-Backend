...
function checkSalesConditions(stringArray, propertyNumber, apiKey, streetAddress, postalCode) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log("Checking Sales Conditions ...");
        // Store sales details from agreement
        const expectedSalesPrice = parseInt(stringArray[7], 10);
        const startDate = parseInt(stringArray[3]);
        const endDate = parseInt(stringArray[4]);
        // Get sales data from API
        const { lastSaleDate, lastSalePrice } = yield (0, getPropertyDetails_1.getPropertyDetails)(apiKey, streetAddress, postalCode, propertyNumber);
